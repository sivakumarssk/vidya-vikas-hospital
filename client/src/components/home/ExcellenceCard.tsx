...
export function ExcellenceCard({ card }: Props) {
  return (
    <article className="group flex h-full flex-col rounded-[1.75rem] border border-black/[0.04] bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-brand-green/10 hover:shadow-xl sm:rounded-[2rem] sm:p-8">
      <div className="mb-5 flex size-14 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-icon-bg to-brand-surface ring-1 ring-black/[0.03] transition group-hover:from-brand-green/10 group-hover:to-brand-green/5 sm:mb-6 sm:size-16">
        <SpecialityIcon icon={card.icon} />
      </div>
