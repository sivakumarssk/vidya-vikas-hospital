  ...
  return (
    <PageScaffold>
      <section className="bg-brand-surface py-14 sm:py-16 lg:py-20">
        <Container>
          <Link to="/technologies" className="text-sm font-semibold text-brand-green hover:underline">
          ...
          <div className="mt-5 rounded-3xl bg-white p-8 shadow-lg sm:p-10">
            ...
            <h1 className="mt-4 font-heading text-4xl font-extrabold text-brand-navy sm:text-5xl">{tech.name}</h1>
            <p className="mt-5 max-w-4xl text-lg leading-relaxed text-brand-muted">{tech.shortDescription}</p>

            <div className="mt-8 grid gap-4 sm:grid-cols-3">
              <div className="rounded-2xl bg-brand-surface p-5">
                <p className="text-xs uppercase tracking-[0.08em] text-brand-muted">Campuses</p>
                <p className="mt-1 font-heading text-xl font-bold text-brand-navy">Sambalpur & network</p>
              </div>
              <div className="rounded-2xl bg-brand-surface p-5">
                <p className="text-xs uppercase tracking-[0.08em] text-brand-muted">Care pathway</p>
                <p className="mt-1 font-heading text-xl font-bold text-brand-navy">Consult → plan → treat</p>
              </div>
              <div className="rounded-2xl bg-brand-surface p-5">
